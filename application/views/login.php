...
<body class="login" style="padding-top:100px">
    ...
    <div class="text-center">
        <img src="<?php echo base_url()?>image/bakti.png" alt="Metis Logo" style="width:100px">
    </div>
    <br>
    <div class="tab-content">
	  ...
	  <form accept-charset="UTF-8" role="form" class="form-signin">
                <p class="text-muted text-center">
                 <strong style="color:green">Aplikasi Surat Rujukan <br> Puskesmas PIR II Bajubang</strong> 
                </p>
    ...
    <div class="text-center">
            ...
            <a class="text-muted" href="#" data-toggle="tab">&copy Dinas Kesehatan Muaro Jambi</a>

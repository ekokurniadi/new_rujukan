...
class Surat_umum extends MY_Controller {
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'surat_umum/index.php?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'surat_umum/index.php?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'surat_umum/index.php';
            $config['first_url'] = base_url() . 'surat_umum/index.php';
        }

        $config['per_page'] = 10;
        $config['page_query_string'] = TRUE;
        $config['total_rows'] = $this->Surat_umum_model->total_rows($q);
        $surat_umum = $this->Surat_umum_model->get_all();
    ...
    public function create() 
    {
       ...
       $this->load->view('headers');
        $this->load->view('surat_umum_form', $data);
         $this->load->view('footers');
    }

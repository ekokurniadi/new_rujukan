...
<section class="section">
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item"><a href="#"> Surat Bpjs </a></div>
    </div>
  </div>
        ...
        <form class="form-horizontal">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input type="text" class="form-control" name="no_kartu" id="no_kartu" placeholder="No Kartu" value="<?php echo $no_kartu; ?>" readonly />
                </div>
              </div>

...
$string .= "\n\n    public function index()
    {
        ...
        if (\$q <> '') {
            \$config['base_url'] = base_url() . '$c_url/index.php?q=' . urlencode(\$q);
            \$config['first_url'] = base_url() . '$c_url/index.php?q=' . urlencode(\$q);
        } else {
            \$config['base_url'] = base_url() . '$c_url/index.php';
            \$config['first_url'] = base_url() . '$c_url/index.php';
        }
